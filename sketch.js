...
var blink,eat,sad;
var mute_btn;
var star,star2, star3, star4, starImg, star2Img, oneStar, twoStar, empty;
var fr;
...
function preload()
{
 ...
 // star2Img = loadAnimation("g_star1.png");
...
function setup() 
{
  ...
  blower.position(280, 360);
  blower.size(100, 100);
  blower.mouseClicked(blow);

  star = createSprite(290, 50, 50, 50);
  star.addImage("star1", starImg);
  star.scale = 0.02
  star3 = createSprite(60, 30, 50, 50);

  star3.addAnimation("empty", empty);
  star3.addAnimation("one", oneStar)
  star3.addAnimation("two", twoStar)
  star3.changeAnimation("empty");
  star3.scale = 0.2

  star2 = createSprite(80, 360, 50, 50);
